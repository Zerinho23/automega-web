...
function AdminLogo() {
  return <Link href="/admin" className="admin-brand"><span className="admin-mark"><i /></span><span><strong>AUTOMEGA <em>SpA</em></strong><small>SOLUCIONES VIALES</small></span></Link>;
}
  ...
  return (
    <div className="admin-layout">
      <aside className={`admin-sidebar ${open ? "open" : ""}`}>
        ...
        <div className="admin-sidebar-footer"><button className="logout" onClick={signOut}><LogOut /> Cerrar sesión</button><p>Vías más seguras<br />para un mejor futuro</p><small>© {new Date().getFullYear()} AUTOMEGA SpA</small></div>
      </aside>
