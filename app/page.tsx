...
export default function Home() {
  ...
  const serviceImages = ["/images/vial.png", "/images/vial2.png", "/images/vial3.png"];
  ...
  return (
    <main>
      ...
      <section className="section" id="servicios">
        <div className="section-heading split-heading"><div><div className="eyebrow">Nuestros servicios</div><h2>Soluciones integrales en seguridad vial</h2><p>Planificamos y ejecutamos cada operación según las necesidades reales del proyecto.</p></div><a className="section-link" href="#contacto">Cotizar un servicio <ArrowRight size={17} /></a></div>
      ...
      <section className="coverage" id="cobertura"><div className="coverage-copy"><div className="eyebrow light">Nuestra cobertura</div><h2>Operación en la <span>Región del Biobío</span></h2><p>Brindamos soluciones de seguridad vial en {site.coverage}, acompañando obras, faenas y desvíos.</p><a className="button button-outline" href="#contacto">Consultar disponibilidad <ChevronRight size={18} /></a></div><div className="coverage-locations"><span>Áreas registradas en nuestros proyectos</span><ul>{(projectLocations.length ? projectLocations : ["Concepción"]).map(location => <li key={location}><CheckCircle2 /> {location}</li>)}</ul></div><div className="coverage-place"><MapPin /><strong>Operación regional</strong><span>{site.coverage}</span></div></section>
